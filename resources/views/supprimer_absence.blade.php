...
<body>
  <div class="text-center m-auto" style="max-width: 720px;">
    ...
    <form action="{{url('supprimer_absence/' . $absence->cne . '/' . $absence->semaine)}}" method="post">
      <p class="text-danger text-center">
        Voulez-vous vraiment supprimer tous les absence de l'éleve <b>{{$absence->cne}}</b> a la semaine <b>{{$absence->semaine}}</b>?
        <br>
